...
public class QuizQuestionsSinema extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionsList = Constants.getQuestionsList10();
        ...
        if (view.getId() == R.id.option_one) {
            ...
            if (mSelectedOptionPosition == -1) {
                if (mCurrentPosition + 1 < mQuestionsList.size()) {
                    ...
                    Intent intent = new Intent(QuizQuestionsSinema.this, ResultActivity.class);
